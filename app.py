...
account_sid = "AC798b396ccd0143548b8a282278712dd4"
auth_token = "003fce69e271736b5b934e412d9f19a2"
...
@app.route('/after_submit', methods=['POST','GET'])
def login_reg_details():
    ...
    if(travel_pass< 30) and request.method == 'POST':
        status = 'CONFIRMED'
        client.messages.create(to="whatsapp:+919381172455",
                               from_="whatsapp:+14155238886",
                               body="Hello "+full_name+" "+"Your Travel From "+" "+source_dt+" To "+dest_dt+" is "+ status+" on "+date+". Thankyou!")
